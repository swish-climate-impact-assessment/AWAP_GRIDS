...
grant ALL on schema awap_grids to ivan_hanigan;
GRANT ALL ON ALL TABLES IN SCHEMA awap_grids TO ivan_hanigan;
grant ALL on all functions in schema awap_grids to ivan_hanigan;
grant ALL on all sequences in schema awap_grids to ivan_hanigan; 
#+end_src
** config
#+name:global.dcf
