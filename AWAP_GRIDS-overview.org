...
**** download
#+name:load-monthly
#+begin_src R :session *R* :tangle src/load-monthly.r :exports none :eval yes
  ################################################################
  # name:load-monthly
  # workdir <- getwd()
  # outdir <- outdir
...
#+RESULTS: load-monthly

**** unzip

#+name:unzip
#+begin_src R :session *R* :tangle src/unzip-monthly.r :exports none :eval yes
  ################################################################
  # name:unzip
  ## load(".RData")
  ## setwd(outdir)
